...
import { db, createArticle, getArticleById, updateArticle, getOrCreateVocabulary, updateVocabulary, linkVocabularyToArticle, getVocabularyForArticle } from '../db.js';
...
router.post('/:id/process', async (req, res) => {
    try {
        ...
        for (const item of vocabularyItems) {
            const vocab = getOrCreateVocabulary(item.chinese);
